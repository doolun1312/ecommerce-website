...
function storeCustomers(message) {
  if (message == "ok") {
      // If the server returns "ok", display a validation message.
    document.getElementById("validation").innerHTML =
      "<a style='color:green' href='login.php'>Password successfully changed, please click here to login with new password</a>";
  } else {
...
$("#form1").submit(function (e) {
  ...
  $.ajax({
    ...
    url: "forgotpassword1.php", success: function(result){
